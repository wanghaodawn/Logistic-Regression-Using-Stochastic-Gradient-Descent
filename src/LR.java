...
//        System.out.println(array.length + "\t" + array[0].length);
	 ...
	 * @param score to be sigmoid
	 * @return score after sigmoid
	 * */
	 ...
	 * @param new_lambda the lambda that needed to be used in this training
	 * @param constant the constant part for updating B[j]
	 * */
